...
<head>
  ...
  <title>OBSERVATORIOS REGIONALES</title>
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center ">
    <div class="container d-flex align-items-center justify-content-between ">
      ...
      <div class="logo">
        <h1><a href="index.html">Observatorios</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="#about">Conocenos</a></li>
          <li><a class="nav-link scrollto active" href="#services">Objetivos</a></li>
          <li><a class="nav-link scrollto active" href="#contact">Contactanos</a></li>
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Observatorios regionales</h2>
        </div>
        ...
        <div class="row d-flex justify-content-center">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="info-box  mb-4">
              <i class="bx bx-envelope"></i>
              <h3>Correo Electrónico</h3>
              <p>observatorio.regional.huetar@una.cr</p>
              <p>adrián.carmona.miranda@una.cr</p>
