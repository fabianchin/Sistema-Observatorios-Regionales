    ...
    <div class="col-12">
      <div class="card mb-4">
        ...
        <div class="text-center">
          ...
          <a class="btn bg-gradient-success w-50 my-4 mb-2" style="color:white"
            href="{{ route('dimension.redirectToCreateDimension') }}">Nueva</a>
            ...
            <table class="table align-items-center mb-0">
              <thead>
                <tr>
                  ...
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Ultima
                    modificacion</th>
                  <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Usuario
                    que modifico</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="align-middle">
                    <a href="{{route('dimension.redirectToUpdateDimension').'?dimension_id='.$dimension->dimension_id}}"
                      class="text-secondary font-weight-bold text-xs" data-toggle="tooltip"
                      data-original-title="Edit user">
                      {{-- SI FUNCIONA PERO PIERDE REF POR SLASH <a
                        href="{{route('dimension.redirectToUpdateDimension',['dimension_id'=>$dimension->dimension_id])}}"
                        class="text-secondary font-weight-bold text-xs" data-toggle="tooltip"
                        data-original-title="Edit user"> --}}
                    ...
                    -->
                      <a style="cursor: pointer;  "
                        onclick="confirm_delete({{$dimension->dimension_id}},'{{$dimension->dimension_name}}')"
                        class="text-secondary font-weight-bold text-xs" data-toggle="tooltip"
                        data-original-title="Delete user">
                        <span style="color:white" class="badge badge-sm bg-gradient-danger">Eliminar</span>
                      </a>
                      <form style="display:none" action="{{route('dimension.delete', $dimension->dimension_id)}}"
                        id="dimension_delete_{{$dimension->dimension_id}}">
                      </form>
                  </td>
                </tr>
                @endforeach
