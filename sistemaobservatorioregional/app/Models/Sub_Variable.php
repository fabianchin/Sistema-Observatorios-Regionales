...
class Sub_Variable extends Model
{
    ...
    protected $fillable = ['sub_variable_name','sub_variable_variable_id'];
    ...
    public function insertSubVariable($sub_variable_variable_id, $sub_variable_name){ return DB::statement('call insertSubVariable (?,?)',[$sub_variable_variable_id,$sub_variable_name]);}
