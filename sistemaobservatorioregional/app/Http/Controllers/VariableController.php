...
class VariableController extends Controller
{
    ...
    public function updateVariable(Request $request)
    {
        ...
        {
            $variableModel = new Variable(); 
            $variableModel->updateVariable($request->variable_id,$request->variable_dimension_id,$request->variable_name,strtoupper($request->variable_acronym));
    ...
    public function insertVariable(Request $request)
    {
        ...
        {
            $variableModel = new Variable(); 
            $variableModel->insertVariable($request->variable_dimension_id,$request->variable_name,strtoupper($request->variable_acronym));
