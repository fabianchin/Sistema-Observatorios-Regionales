...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-04-2023 a las 18:15:04
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `updateSubVariable` (IN `id` INT, IN `variable_id` INT, IN `name_param` VARCHAR(50))   BEGIN
...
--
ALTER TABLE `tb_obs_dimension`
  MODIFY `dimension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tb_obs_sub_variable`
  MODIFY `sub_variable_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
