...
CONSTRAINT fk_indicator_data_cualitative_indicador_detail
    FOREIGN KEY (indicador_id , indicator_region_id)
    REFERENCES tb_obs_indicador_detail (detail_indicator_id , detail_region_id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
CREATE TABLE IF NOT EXISTS tb_obs_indicador_reference (
  ...
  CONSTRAINT fk_indicador_detail_has_reference_indicator
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_indicador_detail_has_reference_reference
