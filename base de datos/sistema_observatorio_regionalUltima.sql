...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-03-2023 a las 18:47:05
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertDimension` (IN `name_param` VARCHAR(50), IN `acronym` VARCHAR(2))   BEGIN
...
UPDATE tb_obs_indicator SET  indicator_name=name_param,indicator_sub_variable=sub_variable, indicator_sub_variable_type=sub_variable_type,indicator_code = code_param
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `updateSubVariable` (IN `id` INT, IN `variable_id` INT, IN `name_param` VARCHAR(50), IN `code_param` INT(2))   BEGIN
UPDATE tb_obs_sub_variable SET  tb_obs_sub_variable.sub_variable_variable_id=variable_id,
tb_obs_sub_variable.sub_variable_name=name_param,tb_obs_sub_variable.sub_variable_code = code_param
...
CREATE TABLE `tb_obs_dimension` (
  ...
  `dimension_name` varchar(50) COLLATE utf8mb4_spanish_ci NOT NULL,
  `dimension_acronym` varchar(2) COLLATE utf8mb4_spanish_ci NOT NULL
...
CREATE TABLE `tb_obs_indicator` (
  ...
  `indicator_name` varchar(50) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
...
CREATE TABLE `tb_obs_indicator_data_cualitative` (
  `indicator_data_description` varchar(500) COLLATE utf8mb4_spanish_ci DEFAULT 'Vacio',
  `indicador_id` int(11) NOT NULL,
  `indicator_region_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;

--
-- Volcado de datos para la tabla `tb_obs_indicator_data_cualitative`
--

INSERT INTO `tb_obs_indicator_data_cualitative` (`indicator_data_description`, `indicador_id`, `indicator_region_id`) VALUES
('test', 24, 4),
('testing array', 26, 5);
...
--
-- Volcado de datos para la tabla `tb_obs_indicator_reference`
--

INSERT INTO `tb_obs_indicator_reference` (`indicator_id`, `indicator_region_id`, `indicator_reference_id`) VALUES
(24, 4, 64),
(26, 5, 65),
(26, 5, 66);
...
CREATE TABLE `tb_obs_list` (
  `list_name` varchar(45) COLLATE utf8mb4_spanish_ci NOT NULL,
  `indicator_id` int(11) NOT NULL,
  `indicator_region_id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `tb_obs_list`
--

INSERT INTO `tb_obs_list` (`list_name`, `indicator_id`, `indicator_region_id`, `measurement_unit_id`) VALUES
('listado 1', 24, 4, 1),
('Lista 1', 26, 5, 2),
('Lista 2', 26, 5, 2),
('Lista 3', 26, 5, 2);
...
CREATE TABLE `tb_obs_log` (
  `user` varchar(45) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `table_name` varchar(45) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `description` varchar(45) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
...
CREATE TABLE `tb_obs_measurement_unit` (
  `measurement_unit_id` int(11) NOT NULL,
  `measurement_unit_description` varchar(45) COLLATE utf8mb4_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
CREATE TABLE `tb_obs_reference` (
  ...
  `reference_link` varchar(100) COLLATE utf8mb4_spanish_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
CREATE TABLE `tb_obs_region` (
  ...
  `region_name` varchar(50) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `region_acronym` varchar(2) COLLATE utf8mb4_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
CREATE TABLE `tb_obs_sub_variable` (
  ...
  `sub_variable_name` varchar(50) COLLATE utf8mb4_spanish_ci NOT NULL,
...
INSERT INTO `tb_obs_sub_variable` (`sub_variable_id`, `sub_variable_name`, `sub_variable_code`, `sub_variable_variable_id`) VALUES
(1, 'Animales en peligro', 1, 4),
(2, 'Salario minimo', 2, 3),
...
CREATE TABLE `tb_obs_variable` (
  ...
  `variable_name` varchar(50) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `variable_acronym` varchar(2) COLLATE utf8mb4_spanish_ci NOT NULL,
...
CREATE TABLE `tb_obs_variable_type` (
  ...
  `variable_type_category` varchar(50) COLLATE utf8mb4_spanish_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
CREATE TABLE `users` (
  ...
  `remember_token` varchar(45) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
...
(1, 'edward', 'ia@mail.com', '$2y$10$gSGRB4imX7.knVJKOHtEBeEjgzdnz3EtKvkPcayHz2l905yMgaBnK', NULL, '2023-03-16 23:45:20', '2023-03-16 23:45:20');
...
--
ALTER TABLE `tb_obs_dimension`
  MODIFY `dimension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `tb_obs_indicator`
--
ALTER TABLE `tb_obs_indicator`
  MODIFY `indicator_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `tb_obs_sub_variable`
  MODIFY `sub_variable_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `tb_obs_indicator_detail`
  ADD CONSTRAINT `fk_indicador_detail_indicator` FOREIGN KEY (`detail_indicator_id`) REFERENCES `tb_obs_indicator` (`indicator_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `tb_obs_indicator_reference`
  ADD CONSTRAINT `fk_indicador_detail_has_reference_indicator` FOREIGN KEY (`indicator_id`,`indicator_region_id`) REFERENCES `tb_obs_indicator_detail` (`detail_indicator_id`, `detail_region_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `tb_obs_list`
  ADD CONSTRAINT `fk_list_indicator_data_cualitative` FOREIGN KEY (`indicator_id`,`indicator_region_id`) REFERENCES `tb_obs_indicator_data_cualitative` (`indicador_id`, `indicator_region_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
